...
(function () {
    ...
    // Render the frame for the current page
        ...
        let i, text, color;
        let x = 10;
        const page_names = ['HOME', 'TEXT', 'COLOR', 'BOX2D', 'COLLISION', 'WORLD', 'FONT', 'UTIL', 'PACING', '3D', 'PERFORMANCE', 'INFO'];
        const page_id = Flynn.mcp.current_state_id;
    ...
    // Handle input commands common to all screens
        ...
        let next_state = Flynn.mcp.current_state_id;
    ...
    Game.StateHome = Flynn.State.extend({
        ...
        render: function (ctx) {
            ...
            // ------------------
            curret_y += 30;
            const text_color = Flynn.Colors.WHITE;
            ctx.vectorText2({
                text: 'TEXT',
                scale: 1.5,
                x: left_x,
