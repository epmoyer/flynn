...
(function () {
    ...
    Flynn.VALogo = Class.extend({
        ...
        bubble_in_inner: function (bubble) {
            const check_offset = bubble.x > 0 ? 2 : -1;
        ...
        // this.angle += this.spin_rate * elapsed_ticks;
            ...
            // Update bubbles
            let length = this.bubbles.length;
            const pacedAcceleration = this.BUBBLE_ACCELERATION * elapsed_ticks;
            const pacedDeceleration = this.BUBBLE_DECELERARION * elapsed_ticks;
