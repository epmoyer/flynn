...
Flynn.init = function(
    ...
    if(typeof(forceUpperCase)==='undefined'){
        forceUpperCase = true;
    }
...
Flynn.Font.Normal = {
    ...
    Points : {
        ...
        ASCII: [
            ...
            [2,0,2,1,2,0],                                                       // '
            [3.5,6,1.95,4,1.95,2,3.5,0],                                                   // (
            [0.5,6,2.05,4,2.05,2,0.5,0],                                                   // )
            ...
            [4,0,0,0,0,6,4,6,9000,7000,0,3,3,3],                                 // E
            ...
            [4,0,4,6,2,6,0,4],                                                   // J
            [0,0,0,6,9000,7000,4,6,0,3,4,0],                                     // K
            [0,0,0,6,4,6],                                                       // L
            ...
            [4,4,0,4,0,6,4,6,4,2,0,2],                                           // a
            [0,2,3,2,4,3,4,5,3,6,0,6,0,0],                                       // b
            [4,2,0,2,0,6,4,6],                                                   // c
            [4,2,1,2,0,3,0,5,1,6,4,6,4,0],                                       // d
            [0,4,4,4,4,2,0,2,0,6,4,6],                                           // e
            [4,0,2,0,1,1,1,6,9000,7000,0,3,3,3],                                 // f
            [4,6,1,6,0,5,0,3,1,2,4,2,4,8,3,9,0,9],                               // g
            [4,6,4,3,3,2,0,2,9000,7000,0,6,0,0],                                 // h
            [2,0,2,0,9000,7000,1,2,2,2,2,6,9000,7000,3,6,1,6],                   // i
            [4,0,4,0,9000,7000,3,2,4,2,4,8,3,9,0,9],                             // j
            [0,4,4,6,9000,7000,4,2,0,4,0,6,0,0],                                 // k
            [1,6,3,6,2,6,2,0,1,0],                                               // l
            [4,6,4,2,2,2,2,4,9000,7000,2,2,0,2,0,6],                             // m
            [0,6,0,2,3,2,4,3,4,6],                                               // n
            [0,6,4,6,4,2,0,2,0,6],                                               // o
            [0,6,3,6,4,5,4,3,3,2,0,2,0,9],                                       // p
            [4,6,1,6,0,5,0,3,1,2,4,2,4,9],                                       // q
            [0,6,0,2,3,2,4,3],                                                   // r
            [0,6,4,6,4,4,0,4,0,2,4,2],                                           // s
            [1,0,1,5,2,6,4,6,9000,7000,0,2,4,2],                                 // t
            [4,2,4,6,0,6,0,2],                                                   // u
            [4,2,2,6,0,2],                                                       // v
            [4,2,4,6,2,4,0,6,0,2],                                               // w
            [0,6,4,2,9000,7000,4,6,0,2],                                         // x
            [0,2,0,5,1,6,4,6,9000,7000,4,2,4,8,3,9,0,9],                         // y
            [4,6,0,6,4,2,0,2],                                                   // z
