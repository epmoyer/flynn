...
Flynn.Font.Points = {
    ...
    ASCII: [
        ...
        [1,0,1,1,9000,8000,3,0,3,1],                                         // "
        [1,5,1,1,9000,8000,0,2,4,2,9000,8000,3,1,3,5,9000,8000,4,4,0,4],     // #
        [0,6,3,6,4,5,4,4,3,3,1,3,0,2,0,1,1,0,4,0,9000,8000,2,0,2,6],         // $        
        [0,6,4,0,9000,8000,2,5,2,1,0,1,0,3,4,3,4,5,2,5],                     // %  
        [4,6,1,2,1,1,2,0,3,1,3,2,0,4,0,5,1,6,2,6,4,4],                       // &  
        [2,0,2,1,2,0],                                                       // '  
        [4,6,3,6,2,5,2,1,3,0,4,0],                                           // (  
        [1,0,2,0,3,1,3,5,2,6,1,6],                                           // )  
        [0,1,4,5,9000,8000,2,5,2,1,9000,8000,4,3,0,3,9000,8000,0,5,4,1],     // *  
        [2,5,2,1,9000,8000,0,3,4,3],                                         // +  
        [2,5,1,6,2,5],                                                       // ,  
        [1,3,3,3],                                                           // -  
        ...
        [0,0,4,0,4,6,0,6,9000,8000,0,3,4,3],                                 // 3
        [4,6,4,0,9000,8000,0,0,0,3,4,3],                                     // 4
        [4,0,0,0,0,3,4,3,4,6,0,6],                                           // 5
        [0,0,0,6,4,6,4,3,0,3],                                               // 6
        [0,0,4,0,4,6],                                                       // 7
        [4,0,4,6,0,6,0,0,4,0,9000,8000,0,3,4,3],                             // 8
        [4,3,0,3,0,0,4,0,4,6],                                               // 9
        [2,1,1.5,1.5,2,2,2.5,1.5,2,1,9000,8000,2,4,1.5,4.5,2,5,2.5,4.5,2,4], // :
        [2,1,1.5,1.5,2,2,2.5,1.5,2,1,9000,8000,1.5,4,2.5,4,1.5,6,1.5,4],     // ;
        [4,1,0,3,4,5,0,3,4,1],                                               // <  
        [0,1.5,4,1.5,9000,8000,0,4.5,4,4.5],                                 // = 
        [0,1,4,3,0,5,4,3,0,1],                                               // >  
        [0,2,0,1,1,0,3,0,4,1,4,2,2,3,2,6,2,3,4,2,4,1,3,0,1,0,0,1,0,2],       // ?  
        [3,4,3,2,1,2,1,4,4,4,4,2,3,1,1,1,0,2,0,4,1,5,3,5],                   // @
        [0,6,0,2,2,0,4,2,4,6,9000,8000,0,4,4,4],                             // A
        [2,3,3,4,3,5,2,6,0,6,0,0,2,0,3,1,3,2,2,3,0,3],                       // B
        [4,0,0,0,0,6,4,6],                                                   // C
        [0,0,0,6,2,6,4,4,4,2,2,0,0,0],                                       // D
        [4,0,0,0,0,6,4,6,9000,8000,0,3,4,3],                                 // E
        [0,6,0,0,4,0,9000,8000,0,3,3,3],                                     // F
        [4,2,4,0,0,0,0,6,4,6,4,4,2,4],                                       // G
        [0,0,0,6,9000,8000,4,6,4,0,9000,8000,0,3,4,3],                       // H
        [0,0,4,0,9000,8000,0,6,4,6,9000,8000,2,0,2,6],                       // I
        [4,0,4,6,2,6,0,4],                                                   // J
        [0,0,0,6,9000,8000,3,6,0,3,3,0],                                     // K
        [0,0,0,6,4,6],                                                       // L
        [0,6,0,0,2,2,4,0,4,6],                                               // M
        [0,6,0,0,4,6,4,0],                                                   // N
        [0,0,4,0,4,6,0,6,0,0],                                               // O
        [0,6,0,0,4,0,4,3,0,3],                                               // P
        [0,0,0,6,2,6,4,4,4,0,0,0,9000,8000,2,4,4,6],                         // Q
        [0,3,4,3,4,0,0,0,0,6,9000,8000,4,6,1,3],                             // R
        [4,0,0,0,0,3,4,3,4,6,0,6],                                           // S
        [0,0,4,0,9000,8000,2,6,2,0],                                         // T
        [0,0,0,6,4,6,4,0],                                                   // U
        [0,0,2,6,4,0],                                                       // V
        [0,0,0,6,2,4,4,6,4,0],                                               // W
        [0,0,4,6,9000,8000,4,0,0,6],                                         // X
        [2,6,2,3,4,0,9000,8000,0,0,2,3],                                     // Y
        [0,0,4,0,0,6,4,6],                                                   // Z
        [3,0,1,0,1,6,3,6],                                                   // [  
        [1,0,3,6],                                                           // /  
        [1,0,3,0,3,6,1,6],                                                   // ]  
