...
(function () {
    ...
    Flynn.Physics = Class.extend({
        init: function (ctx, gravity_x, gravity_y, render_scale) {
            const gravity = new Box2D.Common.Math.b2Vec2(gravity_x, gravity_y);
    ...
    Flynn.Body = Class.extend({
        ...
        init: function (physics, details) {
            ...
            for (const k in this.definitionDefaults) {
            ...
            for (const l in this.fixtureDefaults) {
        ...
        draw: function (context, scale) {
            ...
            if (this.details.color) {
                ...
                case 'circle':
                    ...
                    var first = true;
                    for (let a = 0, stop = Math.PI * 2.01, step = Math.PI * 2 / num_sides; a <= stop; a += step) {
                        if (first) {
